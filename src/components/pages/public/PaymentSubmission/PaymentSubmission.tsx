...
const getPlaceholder = (field: keyof FormValues): string => {
  const map: Record<keyof FormValues, string> = {
    ...
    memberId: "Auto-filled Member ID",
...
export default function MemberDepositForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 mt-12">
          ...
          {({ values, setFieldValue, errors, touched }) => (
            <Form className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
              ...
              <div className="col-span-full">
                <Button
                  type="submit"
                  className="w-full bg-amber-500 text-white hover:bg-amber-600 py-6 text-base"
                >
                  Submit
                </Button>
              </div>
